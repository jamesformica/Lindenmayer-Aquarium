...
},{"./toNumber":"K9rX"}],"Pj0L":[function(require,module,exports) {
...
},{"./_baseRandom":"z9Vv","./_isIterateeCall":"zT1p","./toFinite":"j/W8"}],"d2e6":[function(require,module,exports) {
...
},{"./_createRange":"fitT"}],"0jfV":[function(require,module,exports) {
...
},{"./_arraySample":"0jfV","./_baseSample":"Px+M","./isArray":"+F0h"}],"Bhgs":[function(require,module,exports) {
var e=require("./isArray"),r=require("./isSymbol"),t=/\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/,n=/^\w*$/;function u(u,l){if(e(u))return!1;var o=typeof u;return!("number"!=o&&"symbol"!=o&&"boolean"!=o&&null!=u&&!r(u))||(n.test(u)||!t.test(u)||null!=l&&u in Object(l))}module.exports=u;
},{"./isArray":"+F0h","./isSymbol":"DFEd"}],"6Fwg":[function(require,module,exports) {
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var t=function(){function t(t,e){for(var a=0;a<e.length;a++){var n=e[a];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(t,n.key,n)}}return function(e,a,n){return a&&t(e.prototype,a),n&&t(e,n),e}}(),e=require("lodash/get"),a=s(e),n=require("lodash/sample"),i=s(n);function s(t){return t&&t.__esModule?t:{default:t}}function r(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}var h=function(){function e(t,a,n,s){r(this,e),this.canvas=document.getElementById(t),this.context=this.canvas.getContext("2d"),this.setOptions(a,n,s),this.sentence=this.axiom,this.stateStack=[],this.paintStack=[],this.colour=(0,i.default)(["white","aqua","magenta","lime"]),this.generateSentence(),this.buildPaintStack(),this.paintTree(0)}return t(e,[{key:"setOptions",value:function(t,e,n){this.axiom=t,this.rules=e,this.iterations=(0,a.default)(n,"iterations",2),this.startX=(0,a.default)(n,"x",this.canvas.width/2),this.startY=(0,a.default)(n,"y",this.canvas.height),this.distance=(0,a.default)(n,"distance",15),this.angle=(0,a.default)(n,"angle",20)}},{key:"generateSentence",value:function(){for(var t=0;t<this.iterations;t++){for(var e="",a=0;a<this.sentence.length;a++){for(var n=this.sentence.charAt(a),i=!1,s=0;s<this.rules.length;s++)n===this.rules[s].from&&(i=!0,e+=this.rules[s].to);i||(e+=n)}this.sentence=e}}},{key:"buildPaintStack",value:function(){for(var t=0,e=this.startX,a=this.startY,n=0;n<this.sentence.length;n++)switch(this.sentence.charAt(n)){case"F":var i=e,s=a;e+=Math.sin(t)*this.distance,a-=Math.cos(t)*this.distance,this.paintStack.push({oldX:i,oldY:s,x:e,y:a});break;case"-":t-=this.angle*Math.PI/180;break;case"+":t+=this.angle*Math.PI/180;break;case"[":this.stateStack.push({x:e,y:a,heading:t});break;case"]":var r=this.stateStack.pop();e=r.x,a=r.y,t=r.heading}}},{key:"paintTree",value:function(t){var e=this;requestAnimationFrame(function(){for(var a=0;a<4;a++)if(e.paintBranch(e.paintStack[t]),(t+=1)>=e.paintStack.length)return;e.paintTree(t)})}},{key:"paintBranch",value:function(t){this.context.beginPath(),this.context.strokeStyle=this.colour,this.context.moveTo(t.oldX,t.oldY),this.context.lineTo(t.x,t.y),this.context.stroke(),this.context.closePath()}}]),e}();exports.default=h;
},{"lodash/get":"/BBF","lodash/sample":"wLew"}],"Hovs":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=function(e,t){var i=e.getContext("2d");i.save(),i.beginPath(),i.fillStyle="black",i.fillRect(0,0,e.width,e.height),i.strokeStyle="white",i.lineWidth=2,i.moveTo(0,t),i.lineTo(e.width,t),i.stroke(),i.closePath(),i.restore()};exports.default=e;
},{}],"LXul":[function(require,module,exports) {
module.exports={trees:[{iterations:4,angle:[15,25],distance:[6,12],axiom:"X",rules:[{from:"F",to:"FX[FX[+XF]]"},{from:"X",to:"FF[+XZ++X-F[+ZX]][-X++F-X]"},{from:"Z",to:"[+F-X-F][++ZX]"}]},{iterations:4,angle:[15,25],distance:[6,12],axiom:"X",rules:[{from:"F",to:"FF"},{from:"X",to:"F+[-F-XF-X][+FF][--XF[+X]][++F-X]"}]},{iterations:4,angle:[15,25],distance:[6,12],axiom:"F",rules:[{from:"F",to:"FF+[+F-F-F]-[-F+F+F]"}]},{iterations:7,angle:25,distance:[1,2],axiom:"X",rules:[{from:"X",to:"F[+X][-X]FX"},{from:"F",to:"FF"}]},{iterations:5,angle:[15,25],distance:[6,12],axiom:"F",rules:[{from:"F",to:"F[+F]F[-F]F"}]},{iterations:5,angle:[15,25],distance:[6,12],axiom:"X",rules:[{from:"X",to:"F-[[X]+X]+F[+FX]-X"},{from:"F",to:"FF"}]},{iterations:7,angle:20,distance:[1,2],axiom:"X",rules:[{from:"X",to:"F[+X]F[-X]+X"},{from:"F",to:"FF"}]}]};
},{}],"H99C":[function(require,module,exports) {
"use strict";var e=require("lodash/random"),t=f(e),r=require("lodash/range"),n=f(r),a=require("lodash/sample"),u=f(a),i=require("./tree"),o=f(i),l=require("./scene"),d=f(l),s=require("./trees.json"),c=f(s);function f(e){return e&&e.__esModule?e:{default:e}}var h="ft",m=200,v=function(e,r){var n=e*m,a=n+m;return(0,t.default)(n,a)},g=function(e){return e?e.push?2===e.length?(0,t.default)(e[0],e[1]):console.error("angle array must have exactly 2 values"):e:console.error("tree must have an angle defined")},q=function(e,r){if(!e)return console.error("tree must have a distance defined");var n=void 0;if(e.push){if(2!==e.length)return console.error("distance array must have exactly 2 values");n=(0,t.default)(e[0],e[1])}else n=e;return Math.min(.01*r.height,n)};window.onload=function(){var e=document.getElementById(h);e.width=document.documentElement.clientWidth,e.height=document.documentElement.clientHeight;var t=.8*e.height;requestAnimationFrame(function(){return(0,d.default)(e,t)});var r=Math.floor(e.width/m);(0,n.default)(0,r-1).map(function(r){var n=(0,u.default)(c.default.trees),a={y:t,x:v(r,e),distance:q(n.distance,e),angle:g(n.angle),iterations:n.iterations};requestAnimationFrame(function(){return new o.default(h,n.axiom,n.rules,a)})})};
},{"lodash/random":"Pj0L","lodash/range":"TKv6","lodash/sample":"wLew","./tree":"SvBf","./scene":"Hovs","./trees.json":"LXul"}]},{},["H99C"], null)
//# sourceMappingURL=/Lindenmayer-Aquarium/src.ca3986af.map