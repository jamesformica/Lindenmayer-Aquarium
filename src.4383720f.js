...
var global = arguments[3];
var t=arguments[3];Object.defineProperty(exports,"__esModule",{value:!0});var e=function(){function t(t,e){for(var n=0;n<e.length;n++){var a=e[n];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(t,a.key,a)}}return function(e,n,a){return n&&t(e.prototype,n),a&&t(e,a),e}}(),n=require("lodash/get"),a=r(n),i=require("lodash/sample"),s=r(i);function r(t){return t&&t.__esModule?t:{default:t}}function h(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}var o=function(){function n(e,a,i,r){h(this,n),this.canvas=t.document.getElementById(e),this.context=this.canvas.getContext("2d"),this.setOptions(a,i,r),this.sentence=this.axiom,this.stateStack=[],this.paintStack=[],this.colour=(0,s.default)(["white","aqua","magenta","lime"]),this.generateSentence(),this.buildPaintStack(),this.paintTree(0)}return e(n,[{key:"setOptions",value:function(){return function(t,e,n){this.axiom=t,this.rules=e,this.iterations=(0,a.default)(n,"iterations",2),this.startX=(0,a.default)(n,"x",this.canvas.width/2),this.startY=(0,a.default)(n,"y",this.canvas.height),this.distance=(0,a.default)(n,"distance",15),this.angle=(0,a.default)(n,"angle",20)}}()},{key:"generateSentence",value:function(){return function(){for(var t=0;t<this.iterations;t+=1){for(var e="",n=0;n<this.sentence.length;n+=1){for(var a=this.sentence.charAt(n),i=!1,s=0;s<this.rules.length;s+=1)a===this.rules[s].from&&(i=!0,e+=this.rules[s].to);i||(e+=a)}this.sentence=e}}}()},{key:"buildPaintStack",value:function(){return function(){for(var t=0,e=this.startX,n=this.startY,a=0;a<this.sentence.length;a+=1)switch(this.sentence.charAt(a)){case"F":var i=e,s=n;e+=Math.sin(t)*this.distance,n-=Math.cos(t)*this.distance,this.paintStack.push({oldX:i,oldY:s,x:e,y:n});break;case"-":t-=this.angle*Math.PI/180;break;case"+":t+=this.angle*Math.PI/180;break;case"[":this.stateStack.push({x:e,y:n,heading:t});break;case"]":var r=this.stateStack.pop();e=r.x,n=r.y,t=r.heading}}}()},{key:"paintTree",value:function(){return function(e){var n=this;t.requestAnimationFrame(function(){for(var t=e,a=0;a<4;a+=1)if(n.paintBranch(n.paintStack[t]),(t+=1)>=n.paintStack.length)return;n.paintTree(t)})}}()},{key:"paintBranch",value:function(){return function(t){this.context.beginPath(),this.context.strokeStyle=this.colour,this.context.moveTo(t.oldX,t.oldY),this.context.lineTo(t.x,t.y),this.context.stroke(),this.context.closePath()}}()}]),n}();exports.default=o;
},{"lodash/get":"/BBF","lodash/sample":"wLew"}],"Hovs":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=function(){return function(e,t){var i=e.getContext("2d");i.save(),i.beginPath(),i.fillStyle="black",i.fillRect(0,0,e.width,e.height),i.strokeStyle="white",i.lineWidth=4,i.moveTo(0,t),i.lineTo(e.width,t),i.stroke(),i.closePath(),i.restore()}}();exports.default=e;
...
var global = arguments[3];
var e=arguments[3],t=require("lodash/random"),n=h(t),r=require("lodash/range"),a=h(r),u=require("lodash/sample"),i=h(u),o=require("./tree"),l=h(o),d=require("./scene"),s=h(d),c=require("./trees.json"),f=h(c);function h(e){return e&&e.__esModule?e:{default:e}}var m="ft",v=200,g=function(){return function(e){var t=e*v,r=t+v;return(0,n.default)(t,r)}}(),q=function(){return function(e){return e?e.push?2===e.length?(0,n.default)(e[0],e[1]):console.error("angle array must have exactly 2 values"):e:console.error("tree must have an angle defined")}}(),y=function(){return function(e,t){if(!e)return console.error("tree must have a distance defined");var r=void 0;if(e.push){if(2!==e.length)return console.error("distance array must have exactly 2 values");r=(0,n.default)(e[0],e[1])}else r=e;return Math.min(.01*t.height,r)}}();e.window.onload=function(){var t=e.document.getElementById(m);t.width=e.document.documentElement.clientWidth,t.height=e.document.documentElement.clientHeight;var n=.8*t.height;e.requestAnimationFrame(function(){return(0,s.default)(t,n)});var r=Math.floor(t.width/v);(0,a.default)(0,r-1).forEach(function(r){var a=(0,i.default)(f.default.trees),u={y:n,x:g(r),distance:y(a.distance,t),angle:q(a.angle),iterations:a.iterations};e.requestAnimationFrame(function(){return new l.default(m,a.axiom,a.rules,u)})})};
},{"lodash/random":"Pj0L","lodash/range":"TKv6","lodash/sample":"wLew","./tree":"SvBf","./scene":"Hovs","./trees.json":"LXul"}]},{},["H99C"], null)
//# sourceMappingURL=/Lindenmayer-Aquarium/src.4383720f.map