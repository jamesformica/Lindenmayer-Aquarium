...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/lodash/_baseRange.js":[function(require,module,exports) {
...
},{"./_createRange":"node_modules/lodash/_createRange.js"}],"node_modules/lodash/_baseRandom.js":[function(require,module,exports) {
/* Built-in method references for those with the same name as other `lodash` methods. */
...
},{"./_arraySample":"node_modules/lodash/_arraySample.js","./_baseSample":"node_modules/lodash/_baseSample.js","./isArray":"node_modules/lodash/isArray.js"}],"node_modules/lodash/_coreJsData.js":[function(require,module,exports) {
var root = require('./_root');
...
},{"./_baseDifference":"node_modules/lodash/_baseDifference.js","./_baseRest":"node_modules/lodash/_baseRest.js","./isArrayLikeObject":"node_modules/lodash/isArrayLikeObject.js"}],"node_modules/lodash/_isKey.js":[function(require,module,exports) {
  ...
  _createClass(Tree, [{
    ...
    value: function () {
      function setOptions(axiom, rules, options) {
        ...
        this.colour = (0, _get2['default'])(options, 'colour', 'white');
      }
    ...
    value: function () {
      function generateSentence() {
        for (var f = 0; f < this.iterations; f += 1) {
          var nextSentence = '';
    ...
    value: function () {
      function paintTree() {
        ...
        var drawIndex = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;

        global.requestAnimationFrame(function () {
          var newDrawIndex = drawIndex;
          for (var i = 0; i < 4; i += 1) {
            _this.paintBranch(_this.paintStack[newDrawIndex]);
            newDrawIndex += 1;

            if (newDrawIndex >= _this.paintStack.length) return;
          }

          _this.paintTree(newDrawIndex);
        });
      }
...
},{"lodash/get":"node_modules/lodash/get.js"}],"src/trees.json":[function(require,module,exports) {
"use strict";
...
var paintScene = function () {
  function paintScene(canvas, landY) {
    ...
    ctx.beginPath();
    var water = ctx.createLinearGradient(0, 0, 0, landY);
    ...
    var sand = ctx.createLinearGradient(0, landY, 0, canvas.height);
...
},{}],"node_modules/lodash/random.js":[function(require,module,exports) {
var baseRandom = require('./_baseRandom'),
    isIterateeCall = require('./_isIterateeCall'),
    toFinite = require('./toFinite');
...
},{"./_baseRandom":"node_modules/lodash/_baseRandom.js","./_isIterateeCall":"node_modules/lodash/_isIterateeCall.js","./toFinite":"node_modules/lodash/toFinite.js"}],"src/helpers.js":[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getDistance = exports.getAngle = exports.getX = exports.getLoops = undefined;
...
var getAngle = exports.getAngle = function () {
...
var getDistance = exports.getDistance = function () {
...
},{"lodash/random":"node_modules/lodash/random.js"}],"src/index.js":[function(require,module,exports) {
var global = arguments[3];
'use strict';
...
var CANVAS_ID = 'ft';
var COLOURS = ['white', 'greenyellow', 'magenta', 'aquamarine', 'fuchsia', 'coral', 'yellow', 'indianred'];

global.window.onload = function () {
  var canvas = global.document.getElementById(CANVAS_ID);
  canvas.width = global.document.documentElement.clientWidth;
  canvas.height = global.document.documentElement.clientHeight;

  var colours = [].concat(COLOURS);
  var skyLine = canvas.height * 0.9;

  (0, _scene2['default'])(canvas, skyLine);

  (0, _range2['default'])(0, (0, _helpers.getLoops)(canvas)).forEach(function (i) {
    var tree = (0, _sample2['default'])(_trees2['default'].trees);
    var colour = (0, _sample2['default'])(colours);
    ...
    colours = (0, _without2['default'])(colours, colour);
    new _tree2['default'](CANVAS_ID, tree.axiom, tree.rules, options).paintTree();
  });
};
},{"lodash/range":"node_modules/lodash/range.js","lodash/sample":"node_modules/lodash/sample.js","lodash/without":"node_modules/lodash/without.js","./tree":"src/tree.js","./trees.json":"src/trees.json","./scene":"src/scene.js","./helpers":"src/helpers.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/src.cf0eb033.map