...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/lodash/_baseRandom.js":[function(require,module,exports) {
...
},{"./_baseRandom":"node_modules/lodash/_baseRandom.js","./_isIterateeCall":"node_modules/lodash/_isIterateeCall.js","./toFinite":"node_modules/lodash/toFinite.js"}],"node_modules/lodash/_baseRange.js":[function(require,module,exports) {
/* Built-in method references for those with the same name as other `lodash` methods. */
...
},{"./_createRange":"node_modules/lodash/_createRange.js"}],"node_modules/lodash/_arraySample.js":[function(require,module,exports) {
var baseRandom = require('./_baseRandom');
...
},{"./_arraySample":"node_modules/lodash/_arraySample.js","./_baseSample":"node_modules/lodash/_baseSample.js","./isArray":"node_modules/lodash/isArray.js"}],"node_modules/lodash/_isKey.js":[function(require,module,exports) {
...
},{"./_baseGet":"node_modules/lodash/_baseGet.js"}],"src/tree.js":[function(require,module,exports) {
'use strict';
...
var Tree = function () {
  function Tree(canvasId, axiom, rules, options) {
    ...
    this.stateStack = [];
    this.paintStack = [];
    this.colour = (0, _sample2['default'])(['white', 'aqua', 'magenta', 'lime']);
  ...
  _createClass(Tree, [{
    key: 'setOptions',
    value: function () {
      function setOptions(axiom, rules, options) {
        this.axiom = axiom;
        this.rules = rules;
        this.iterations = (0, _get2['default'])(options, 'iterations', 2);
        this.startX = (0, _get2['default'])(options, 'x', this.canvas.width / 2);
        this.startY = (0, _get2['default'])(options, 'y', this.canvas.height);
        this.distance = (0, _get2['default'])(options, 'distance', 15);
        this.angle = (0, _get2['default'])(options, 'angle', 20);
      }
      ...
      function generateSentence() {
        for (var f = 0; f < this.iterations; f++) {
          ...
          for (var i = 0; i < this.sentence.length; i++) {
            var char = this.sentence.charAt(i);
            var found = false;
    ...
    value: function () {
      function buildPaintStack() {
        ...
        for (var i = 0; i < this.sentence.length; i++) {
          switch (this.sentence.charAt(i)) {
            ...
            case '[':
              {
                this.stateStack.push({ x: x, y: y, heading: heading });
                break;
              }
            case ']':
              {
                ...
                x = _stateStack$pop.x;
                y = _stateStack$pop.y;
                heading = _stateStack$pop.heading;
      ...
      return buildPaintStack;
    }()
  }, {
    key: 'paintTree',
    value: function () {
      function paintTree(drawIndex) {
        var _this = this;

        requestAnimationFrame(function () {
          for (var i = 0; i < 4; i++) {
            _this.paintBranch(_this.paintStack[drawIndex]);
            drawIndex += 1;

            if (drawIndex >= _this.paintStack.length) return;
          }

          _this.paintTree(drawIndex);
        });
      }
...
},{"lodash/get":"node_modules/lodash/get.js","lodash/sample":"node_modules/lodash/sample.js"}],"src/scene.js":[function(require,module,exports) {
'use strict';
...
var paintScene = function () {
  function paintScene(canvas, landY) {
...
exports['default'] = paintScene;
},{}],"src/trees.json":[function(require,module,exports) {
"use strict";
...
var getAngle = function () {
  function getAngle(angle) {
    ...
    if (angle.push) {
      if (angle.length === 2) {
        return (0, _random2['default'])(angle[0], angle[1]);
      }
...
var getDistance = function () {
  function getDistance(distance, canvas) {
    if (!distance) return console.error('tree must have a distance defined');

    var dist = void 0;
    if (distance.push) {
      if (distance.length === 2) {
        dist = (0, _random2['default'])(distance[0], distance[1]);
      } else {
...
window.onload = function () {
  ...
  var skyLine = canvas.height * 0.8;

  requestAnimationFrame(function () {
    return (0, _scene2['default'])(canvas, skyLine);
  });

  var loops = Math.floor(canvas.width / SPACING);

  (0, _range2['default'])(0, loops - 1).map(function (i) {
    var tree = (0, _sample2['default'])(_trees2['default'].trees);
    ...
    requestAnimationFrame(function () {
      return new _tree2['default'](CANVAS_ID, tree.axiom, tree.rules, options);
    });
  });
};
},{"lodash/random":"node_modules/lodash/random.js","lodash/range":"node_modules/lodash/range.js","lodash/sample":"node_modules/lodash/sample.js","./tree":"src/tree.js","./scene":"src/scene.js","./trees.json":"src/trees.json"}],"../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/src.eab4c5fd.map