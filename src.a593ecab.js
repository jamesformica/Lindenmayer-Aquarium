...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var t=function(){function t(t,e){for(var n=0;n<e.length;n++){var a=e[n];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(t,a.key,a)}}return function(e,n,a){return n&&t(e.prototype,n),a&&t(e,a),e}}(),e=require("lodash/get"),n=s(e),a=require("lodash/sample"),i=s(a);function s(t){return t&&t.__esModule?t:{default:t}}function r(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}var h=function(){function e(t,n,a,s){r(this,e),this.canvas=document.getElementById(t),this.context=this.canvas.getContext("2d"),this.setOptions(n,a,s),this.sentence=this.axiom,this.stateStack=[],this.paintStack=[],this.colour=(0,i.default)(["white","aqua","magenta","lime"]),this.generateSentence(),this.buildPaintStack(),this.paintTree(0)}return t(e,[{key:"setOptions",value:function(){return function(t,e,a){this.axiom=t,this.rules=e,this.iterations=(0,n.default)(a,"iterations",2),this.startX=(0,n.default)(a,"x",this.canvas.width/2),this.startY=(0,n.default)(a,"y",this.canvas.height),this.distance=(0,n.default)(a,"distance",15),this.angle=(0,n.default)(a,"angle",20)}}()},{key:"generateSentence",value:function(){return function(){for(var t=0;t<this.iterations;t++){for(var e="",n=0;n<this.sentence.length;n++){for(var a=this.sentence.charAt(n),i=!1,s=0;s<this.rules.length;s++)a===this.rules[s].from&&(i=!0,e+=this.rules[s].to);i||(e+=a)}this.sentence=e}}}()},{key:"buildPaintStack",value:function(){return function(){for(var t=0,e=this.startX,n=this.startY,a=0;a<this.sentence.length;a++)switch(this.sentence.charAt(a)){case"F":var i=e,s=n;e+=Math.sin(t)*this.distance,n-=Math.cos(t)*this.distance,this.paintStack.push({oldX:i,oldY:s,x:e,y:n});break;case"-":t-=this.angle*Math.PI/180;break;case"+":t+=this.angle*Math.PI/180;break;case"[":this.stateStack.push({x:e,y:n,heading:t});break;case"]":var r=this.stateStack.pop();e=r.x,n=r.y,t=r.heading}}}()},{key:"paintTree",value:function(){return function(t){var e=this;requestAnimationFrame(function(){for(var n=0;n<4;n++)if(e.paintBranch(e.paintStack[t]),(t+=1)>=e.paintStack.length)return;e.paintTree(t)})}}()},{key:"paintBranch",value:function(){return function(t){this.context.beginPath(),this.context.strokeStyle=this.colour,this.context.moveTo(t.oldX,t.oldY),this.context.lineTo(t.x,t.y),this.context.stroke(),this.context.closePath()}}()}]),e}();exports.default=h;
},{"lodash/get":"/BBF","lodash/sample":"wLew"}],"Hovs":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=function(){return function(e,t){var i=e.getContext("2d");i.save(),i.beginPath(),i.fillStyle="black",i.fillRect(0,0,e.width,e.height),i.strokeStyle="white",i.lineWidth=2,i.moveTo(0,t),i.lineTo(e.width,t),i.stroke(),i.closePath(),i.restore()}}();exports.default=e;
...
"use strict";var e=require("lodash/random"),t=f(e),n=require("lodash/range"),r=f(n),a=require("lodash/sample"),u=f(a),i=require("./tree"),o=f(i),l=require("./scene"),d=f(l),s=require("./trees.json"),c=f(s);function f(e){return e&&e.__esModule?e:{default:e}}var h="ft",m=200,v=function(){return function(e,n){var r=e*m,a=r+m;return(0,t.default)(r,a)}}(),g=function(){return function(e){return e?e.push?2===e.length?(0,t.default)(e[0],e[1]):console.error("angle array must have exactly 2 values"):e:console.error("tree must have an angle defined")}}(),q=function(){return function(e,n){if(!e)return console.error("tree must have a distance defined");var r=void 0;if(e.push){if(2!==e.length)return console.error("distance array must have exactly 2 values");r=(0,t.default)(e[0],e[1])}else r=e;return Math.min(.01*n.height,r)}}();window.onload=function(){var e=document.getElementById(h);e.width=document.documentElement.clientWidth,e.height=document.documentElement.clientHeight;var t=.8*e.height;requestAnimationFrame(function(){return(0,d.default)(e,t)});var n=Math.floor(e.width/m);(0,r.default)(0,n-1).map(function(n){var r=(0,u.default)(c.default.trees),a={y:t,x:v(n,e),distance:q(r.distance,e),angle:g(r.angle),iterations:r.iterations};requestAnimationFrame(function(){return new o.default(h,r.axiom,r.rules,a)})})};
},{"lodash/random":"Pj0L","lodash/range":"TKv6","lodash/sample":"wLew","./tree":"SvBf","./scene":"Hovs","./trees.json":"LXul"}]},{},["H99C"], null)
//# sourceMappingURL=/Lindenmayer-Aquarium/src.a593ecab.map